<script lang="ts">
    ...
    import { requestBackup } from '../../common/backupScheduler';
    import '@smui/button';
    ...
    async function updateTransaction(status: TransactionStatus) {
        ...
        try {
            ...
            // Approve/reject/cancel all mutate the source chain (status
            // transitions on the transaction + DebtContract creation on
            // accept). Schedule a backup so recovery reflects the change.
