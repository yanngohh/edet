<script lang="ts">
    ...
    import { startDueNotices, stopDueNotices } from './lib/due';
    import { startAutopay, stopAutopay } from './lib/autopay';
    ...
    async function boot(): Promise<void> {
        ...
        startWaitingNotices();
        // A debt of this member's falling due or past due, said once per
        // contract per state; and the one standing instruction the wallet
        // carries, which opens the payment request the day before.
        startDueNotices();
        startAutopay();
